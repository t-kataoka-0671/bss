...
import cish_sys.dao.MstEngineerDao;
import cish_sys.web.AbstractCrudPage;

public abstract class AbstractMstEngineerPage extends AbstractCrudPage {

	private MstEngineerDao mstEngineerDao;
	
	private MstEngineerDxo mstEngineerDxo;
	...
	public AbstractMstEngineerPage() {
	}
	...
	public MstEngineerDao getMstEngineerDao() {
		return this.mstEngineerDao;
	}

	public void setMstEngineerDao(MstEngineerDao mstEngineerDao) {
		this.mstEngineerDao = mstEngineerDao;
	}

	public MstEngineerDxo getMstEngineerDxo() {
		return this.mstEngineerDxo;
	}

	public void setMstEngineerDxo(MstEngineerDxo mstEngineerDxo) {
		this.mstEngineerDxo = mstEngineerDxo;
	}
}