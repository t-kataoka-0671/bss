...
public abstract class AbstractMstUserPage extends AbstractCrudPage {

	private MstUserDao mstUserDao;
	
	private MstUserDxo mstUserDxo;
	...
	public MstUserDxo getMstUserDxo() {
		return this.mstUserDxo;
	}

	public void setMstUserDxo(MstUserDxo mstUserDxo) {
		this.mstUserDxo = mstUserDxo;
	}
}